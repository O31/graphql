...
function generateLoginPage() {
    ...
    if (token == null) {
        ...
        loginDiv.append(createElement("p", "", ["mainError", "error"]))
        ...
        loginDiv.append(createElement("p", "", ["unError", "error"]))
        loginDiv.append(uLabel)
        loginDiv.append(emailInput)
        let pwLabel = createElement("label", "PASSWORD:", ["loginP"])
        pwLabel.setAttribute("for", "pword")
        loginDiv.append(createElement("p", "", ["pwError", "error"]))
        loginDiv.append(pwLabel)
